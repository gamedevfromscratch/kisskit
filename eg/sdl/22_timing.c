...
int draw(void)
{
	...
	for (i = -3; i < 4; ++i) {
		target = (SDL_Rect) {
		w / 2 - tw / 2 + 4 * i, h / 2 - th / 2 + th * i, tw, th};
...
int main(void)
{
	...
	text1 = TEXTURE_FROM_TEXT(font1, "Press Enter to Reset Start Time.", (SDL_Color){0xFF, 0xFF, 0xFF, 0xFF});
